...
use crate::memory::{GpuBuffer, GpuMemoryAllocator};
use crate::swapchain::Swapchain;
use crate::surface;
use crate::pipeline;
use crate::texture::{DepthBuffer, GpuTexture, Framebuffer};
...
impl Renderer {
    ...
    pub fn transition_image_layout(&self, cmd: vk::CommandBuffer, image: vk::Image, aspect: vk::ImageAspectFlags, old_layout: vk::ImageLayout, new_layout: vk::ImageLayout) {
        let (src_stage, dst_stage, src_mask, dst_mask) = match (old_layout, new_layout) {
